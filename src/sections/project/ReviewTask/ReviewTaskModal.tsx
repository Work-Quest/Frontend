...
export const ReviewTaskModal: React.FC<ReviewTaskModalProps> = ({
  ...
  const [selectedSource, setSelectedSource] = useState<"latest" | "other">(
    "latest",
  )
  const [selectedLogId, setSelectedLogId] = useState<string>(
    defaultLatestSelectedId,
  )
  ...
  const selectedOtherLog = otherLogsOptions.find(
    (log) => log.id === selectedOtherLogId,
  )
              ...
              <div className="flex-1 min-h-0 overflow-hidden px-6 pb-6">
                <ScrollArea className="h-full">
                    ...
                    {latestLogs.map((log) => {
                      ...
                      return (
                        <LatestLogCard
                          ...
                          reviewValue={
                            isSelectedLatest ? reviewText : undefined
                          }
                          onReviewChange={
                            isSelectedLatest ? setReviewText : undefined
                          }
                  ...
                  <div className="flex items-center gap-2 shrink-0 my-2">
                    ...
                    <span className="text-darkBrown/70 text-sm font-['Baloo_2']">
                      or
                    </span>
                    <div className="flex-1 h-px bg-darkBrown/20" />
                  </div>
                  ...
                  <Select
                    value={selectedOtherLogId}
                    onValueChange={handleSelectOtherLog}
                  >
                  ...
                  {selectedSource === "other" && selectedOtherLog && (
                    <div className="mt-3">
                      <LatestLogCard
                        ...
                        onSelect={() =>
                          handleSelectOtherLog(selectedOtherLog.id)
                        }
                      />
                    </div>
                  )}
    ...
    <div
      className={`rounded-lg border p-4 flex flex-col gap-2 font-['Baloo_2'] cursor-pointer ${
        isHighlighted
          ...
          : "bg-white/80 border-darkBrown/5"
      }`}
      onClick={onSelect}
    >
...
function HistoryCard({
  ...
  return (
    <div className="rounded-lg bg-offWhite border border-lightBrown p-4 flex flex-col gap-2 font-['Baloo_2']">
      <div className="flex items-baseline justify-between gap-2">
        ...
        <p className="text-darkBrown/90 text-sm">
          ...
          {needsTruncate && (
            <button
              ...
              className="!ml-1 !text-blue-600 !underline hover:!text-blue-800 font-['Baloo_2'] !bg-transparent !border-none !p-0 !m-0"
            >
