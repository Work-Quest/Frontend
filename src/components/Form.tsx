              ...
              <div className="self-stretch text-center justify-start">
                {method === "login" ? (
                  <p className="text-darkBrown">
                    ...
                    <a href="/register">
                      <span className="cursor-pointer text-orange font-medium hover:underline hover:text-red">Register now</span>
                    </a>
                  </p>
                ) : (
                  <p className="text-darkBrown">
                    ...
                    <a href="/login">
                      <span className="cursor-pointer text-orange font-medium hover:underline hover:text-red">Log in now</span>
                    </a>
                  </p>
                )}
              </div>
