...
export default function Modal({
  ...
  const defaultFooter = (
    <div className="flex items-center justify-end gap-3 px-6 py-3 border-t border-darkBrown/10 shrink-0">
      <Button
        variant="default"
        className="px-6 font-baloo2 !font-bold"
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className={`!w-[66.666vw] !min-w-[320px] !max-w-[95vw] h-[80vh] min-h-[420px] max-h-[90vh] p-0 gap-0 overflow-hidden flex flex-col font-baloo2 ${className}`}
      >
        <div className="flex flex-col flex-1 min-h-0 rounded-lg overflow-hidden bg-offWhite/90">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-darkBrown/10 shrink-0">
            <h2 className="text-2xl font-bold text-darkBrown font-baloo2">{title}</h2>
          </div>
