  ...
  return (
    <div
      ...
      className={cn(
        ...
        "border-b-2 border-dashed border-gray-300 pb-4 mb-2",
        className,
      )}
      {...props}
    />
...
function DialogTitle({ className, ...props }: React.ComponentProps<typeof DialogPrimitive.Title>) {
  return (
    <DialogPrimitive.Title
      ...
      className={cn("text-xl font-bold text-gray-800 drop-shadow-sm font-serif", className)}
      {...props}
    />
  )
}
...
function DialogDescription({ className, ...props }: React.ComponentProps<typeof DialogPrimitive.Description>) {
  return (
    <DialogPrimitive.Description
      ...
      className={cn("text-gray-600 text-sm leading-relaxed font-medium", className)}
      {...props}
    />
  )
}
