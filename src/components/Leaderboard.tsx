        ...
        <div className="self-stretch p-5 bg-[#ff995a] rounded-[10px] flex justify-between items-center mb-4">
          <div className="flex items-center gap-4">
            ...
            <div className="w-[168px] flex flex-col items-start">
              <p className="!text-offWhite underline">1st Place!</p>
              <h3 className="!text-offWhite">{firstPlace.name}</h3>
              <button
                onClick={() => handleProfileClick(firstPlace.user_id)}
                className="text-cream text-base !p-0 font-medium -mt-2 !bg-transparent hover:underline cursor-pointer"
              >
                @{firstPlace.username}
              </button>
            </div>
                ...
                >
                  <div className="flex justify-between items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      <h3 className="!text-lightBrown">{i.score}</h3>
                      <svg
