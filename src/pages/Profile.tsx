  ...
  return (
    ...
    <div className="p-8 h-[calc(100vh-140px)] overflow-hidden flex items-center bg-offWhite gap-4">
      <div className="w-[550px] h-full flex flex-col gap-4">
        <UserInfo profilePicture="https://github.com/shadcn.png" name="Atikarn Kruaykriangkrai" username="littleJohn" />
        <Friends friends={FriendsMockData.friends} friendsCount={FriendsMockData.friends.length}/>
      </div>
